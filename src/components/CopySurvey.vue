          ...
          <div class="stepper">
            ...
            <div class="card-body2">
              <div class="stepper-content" v-for="item in 6" :key="item">
                <div  v-if="currentStep == item">
                  <h2>{{ formSteps[currentStep].title }}</h2>

                  <!-- STEP ONE -->
                  <div class="step-form-one" v-if="currentStep === 1">
                        <div class="form-step-one" v-for="n in numbers" :key="n.id">
...
.stepper-item.success .stepper-item-counter  {
  border-color: #871a89 ;
  background-color: #871a89; /* color de los circulos de los stepper*/  
  color: #fff;
  font-weight: 600px;
}
...
.btn {
  ...
  border-color: #f0f0f0;
  font-size: 18px;    /* le cambie el tamaño de los botones ya que considere que es una buena practica de accesbilidad web*/
  font-weight: bold;
}
.btn:disabled {
  opacity: 0.5;
